...
public class AppTest{
    ...
    public static void main(String[] args) {
        ...
        while (combat.aliveVerification(player)) {
            ...
            System.out.println("\n--- New combat: " + enemy.getName() + " ---");
            while (combat.aliveVerification(player) && combat.aliveVerification(enemy)) {
                System.out.println("\nChoose an action:");
            ...
            if (!combat.aliveVerification(enemy)) {
